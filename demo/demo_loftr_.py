...
if __name__ == '__main__':
    ...
    self.disps = torch.ones(buffer, ht, wd, device="cuda", dtype=torch.float).share_memory_()
    ...
    last_data = {'image0': frame_tensor}   #固定帧
    last_frame = frame
    ...
    while True:
        ...
        frame_tensor = frame2tensor(frame, device)
        last_data = {**last_data, 'image1': frame_tensor} #这个last_data是之前所有的帧么？
        #print(last_data) #---------------
        ###########################
        # if frame_id ==3:
        #     break
